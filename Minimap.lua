...
local floor, cos, sin, rad, deg, atan2 = math.floor, math.cos, math.sin, math.rad, math.deg, math.atan2
...
function Button:Build()
	...
	b:SetScript("OnEnter", function(self2)
		...
		GameTooltip:AddLine("Right click: show or hide the Life Tap readout", 1, 1, 1)
