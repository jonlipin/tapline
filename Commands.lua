...
function ns.Usage()
	...
	Print("  /tapline cost <health> | auto - what a Life Tap costs, which only the self report uses")
	Print("  /tapline rank <1-6> | auto - which rank of Life Tap that cost is read from")
	Print("  /tapline sound - list the sounds; applied | lapsed | estimate <n> to set one")
